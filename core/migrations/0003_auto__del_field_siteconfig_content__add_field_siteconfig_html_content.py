...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteConfig.html_content'
        db.add_column(u'core_siteconfig', 'html_content',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SiteConfig.html_content'
        db.delete_column(u'core_siteconfig', 'html_content')
